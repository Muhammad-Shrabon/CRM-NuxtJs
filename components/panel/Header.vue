            ...
            <div class="usr_menu">
                <ul class="flex gap-2 lg:gap-5 items-center"> 
                    ...
                    @mouseleave="hoverState.profile = false" class="flex items-center gap-1 lg:gap-5 cursor-pointer relative" >
                        ...
                        <span class=" block overflow-hidden"><img class="w-12 h-12 rounded-full border-panel-sub-dark border-4 object-cover" :src="user['profile']  || 'https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_640.png'" alt="profle"></span>

<template>
  <div class="settings-page min-h-screen">
    ...
    <p v-else-if="error">{{ error.message || 'Error loading users' }}</p>
    ...
    <div v-else>
      ...
      <div v-if="client">
       ...
       <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4">
        ...
        :freelancerName="data.freelancerId"
       ...
       <div class="top col-span-12 sm:col-span-6 md:col-span-12 lg:col-span-12 xl:col-span-8">
        <div class="bg-panel-ddark/0 border border-panel-text-light/20 rounded-xl p-1 md:p-5">
          <h2 class="font-medium text-xl md:text-4xl text-panel-text-light font-jost flex gap-5 items-center mb-10"><Icon icon="mingcute:flash-fill"/> {{ data.projectTitle }}</h2>
                  ...
                  <div class="w-1/2 md:w-1/3 p-2">
                    <div class="sml_crd h-full border-2 p-4 rounded-xl bg-panel-sub-dark border-panel-sub-dark">
                        <div class="status text-center h-full">
                          ...
                          <p  class="font-jost text-xs md:text-lg font-medium capitalize text-panel-text-light md:pt-3 flex gap-3 justify-center items-center">{{ data.status }}
                  ...
                  <div class="w-1/2 md:w-1/3 p-2">
                    <div class="sml_crd h-full border-2  p-4 rounded-xl bg-panel-sub-dark border-panel-sub-dark">
                      <div class="task h-full text-center">
                        ...
                        <h6 class="font-jost text-xs md:text-lg font-bold text-panel-text-light md:pt-3">{{ data.dueDate }}</h6>
                      </div>
                    </div>
                  </div>
                  <div class="w-1/2 md:w-1/2 p-2">
                    <div class="sml_crd h-full border-2  p-4 rounded-xl bg-panel-sub-dark border-panel-sub-dark">
                      <div class="task h-full text-center">
                        ...
                        <h6 class="font-jost text-xs md:text-lg font-bold text-panel-text-light md:pt-3">BDT: {{ data.budgetAmount }} TK.</h6>
                      </div>
                    </div>
                  </div>
                  <div class="w-full md:w-1/2 p-2">
                    <div class="sml_crd h-full  p-4 rounded-xl bg-panel-sub-dark">
                      <div class="task h-full text-center">
                        ...
                        <h6 class="font-jost text-lg font-bold text-blue-200 pt-3">{{ data.projectCode }}</h6>
                      </div>
                    </div>
                  </div>
              </div>
  ...
  try {
    ...
    if (response.data) {
      ...
      data.value = {
       ...
       console.log('p-view-ind:', data.value.clientUsername)
    } else {
